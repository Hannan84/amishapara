                ...
                <form action="{{route('categories.store')}}" method="POST" class=row data-parsley-validate=""  enctype="multipart/form-data">
                    ...
                    <div class="col-sm-12">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control @error('bn_name') is-invalid @enderror" name="bn_name" value="{{ old('bn_name') }}" id="bn_name" required="">
                            @error('bn_name')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="col mb-3">
                        <div class="form-group">
                            <label for="featured" class="d-block">Top Featured</label>
                            <label class="switch">
